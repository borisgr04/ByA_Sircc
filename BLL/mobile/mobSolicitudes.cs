...
namespace BLL.mobile
{
    public class mobSolicitudes
    {
        ...
        public List<vPESTADOS> getxEstados(string DepDel, short Vigencia)
        {
            ...
            using (ctx = new Entities())
            {
                ...
                var Aceptadas = ctx.PSOLICITUDES.Where(t => t.DEP_PSOL == DepDel && t.VIG_SOL == Vigencia && t.ID_ABOG_ENC != null && t.HREVISADO1.RECIBIDO_ABOG == "S" && t.HREVISADO1.CONCEPTO_REVISADO == "A").Count();
                e = new vPESTADOS
                {
                    COD_EST = "AC",
                    NOM_EST = "Aceptadas",
                ...
                var Rechazadas = ctx.PSOLICITUDES.Where(t => t.DEP_PSOL == DepDel && t.VIG_SOL == Vigencia && t.ID_ABOG_ENC != null && t.HREVISADO1.RECIBIDO_ABOG == "S" && t.HREVISADO1.CONCEPTO_REVISADO == "R").Count();
                e = new vPESTADOS
                {
                    COD_EST = "RE",
                    NOM_EST = "Rechazadas",
        ...
        public List<vPSolicitudesM> getSolicitudesxEst(string DepDel, string Estado, short Vigencia)
        {
            List<vPSolicitudesM> lt=null;
            using (ctx = new Entities())
            {
                if (Estado == "Por Asignar")
                {
                    lt = ctx.PSOLICITUDES.Where(t => t.DEP_PSOL == DepDel && t.VIG_SOL == Vigencia && t.ID_ABOG_ENC == null)
                        .Select( t => new vPSolicitudesM
                        {
                             COD_SOL=t.COD_SOL,
                             OBJ_SOL = t.OBJ_SOL,
                             VAL_CON = t.VAL_CON,
                ...
                if (Estado == "Pendientes")
                {
                    ...
                    lt= ctx.PSOLICITUDES.Where(t => t.DEP_PSOL == DepDel && t.VIG_SOL == Vigencia && t.ID_ABOG_ENC != null && t.HREVISADO1.RECIBIDO_ABOG == "S" && t.HREVISADO1.CONCEPTO_REVISADO == "P").Select(
                        t => new vPSolicitudesM
                        {
                             COD_SOL=t.COD_SOL,
                             OBJ_SOL = t.OBJ_SOL,
                ...
                if (Estado == "Aceptadas")
                {
                    lt = ctx.PSOLICITUDES.Where(t => t.DEP_PSOL == DepDel && t.VIG_SOL == Vigencia && t.ID_ABOG_ENC != null && t.HREVISADO1.RECIBIDO_ABOG == "S" && t.HREVISADO1.CONCEPTO_REVISADO == "A").Select(
                        t => new vPSolicitudesM
                        {
                             COD_SOL=t.COD_SOL,
                             OBJ_SOL = t.OBJ_SOL,
                ...
                {
                    lt = ctx.PSOLICITUDES.Where(t => t.DEP_PSOL == DepDel && t.VIG_SOL == Vigencia && t.ID_ABOG_ENC != null && t.HREVISADO1.RECIBIDO_ABOG == "S" && t.HREVISADO1.CONCEPTO_REVISADO == "R").Select(
                        t => new vPSolicitudesM
                        {
                             COD_SOL=t.COD_SOL,
                             OBJ_SOL = t.OBJ_SOL,
    ...
    public List<vPSolicitudesM> getProcesosDN(string DepDel, string DepNec, short Vigencia)
        {
            List<vPSolicitudesM> lt;
            using (ctx = new Entities())
            {

                lt = ctx.PSOLICITUDES.Where(t => t.DEP_PSOL == DepDel && t.DEP_SOL == DepNec && t.VIG_SOL == Vigencia).Select(
                        t => new vPSolicitudesM
                        {
                             COD_SOL=t.COD_SOL,
                             OBJ_SOL = t.OBJ_SOL,
    ...
    public List<vPSolicitudesM> getProcesos(string Ide_Fun, short Vigencia)
    {
        List<vPSolicitudesM> lt;
        using (ctx = new Entities())
        {
                lt = ctx.PSOLICITUDES.Where(t => t.HREVISADO1.NIT_ABOG_RECIBE == Ide_Fun && t.VIG_SOL == Vigencia).Select(
                        t => new vPSolicitudesM
                        {
                            COD_SOL = t.COD_SOL,
                            OBJ_SOL = t.OBJ_SOL,
