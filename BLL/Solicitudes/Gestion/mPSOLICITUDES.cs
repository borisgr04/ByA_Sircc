        ...
        public List<vPSolicitudes> GetMisSolicitudesxEst(string UserName, string Estado, short Vigencia)
        {
            ...
            using (ctx = new Entities())
            {
                if (Estado == "SREC")
                {
                    ...
                    var q  = ctx.PSOLICITUDES.Where(t => t.VIG_SOL == Vigencia && t.ID_ABOG_ENC == UserName && t.HREVISADO1.RECIBIDO_ABOG == "N")
                    .Select(
                    t => new vPSolicitudes
                    {
                        EST_REC = t.HREVISADO1.RECIBIDO_ABOG,
                ...
                if (Estado == "SREV")
                {
                    //&& t.HREVISADO1.RECIBIDO_ABOG == "S" && t.HREVISADO1.CONCEPTO_REVISADO == "P"
                    //var q = ctx.PSOLICITUDES.Where(t=> t.ID_ABOG_ENC == UserName && t.HREVISADO1.RECIBIDO_ABOG == "S" && t.HREVISADO1.CONCEPTO_REVISADO == "P");

                    var q = ctx.PSOLICITUDES.Where(t => t.VIG_SOL == Vigencia && t.ID_ABOG_ENC == UserName && t.HREVISADO1.RECIBIDO_ABOG == "S" && t.HREVISADO1.CONCEPTO_REVISADO == "P")
                        .Select(
                t => new vPSolicitudes
                {
                    EST_REC = t.HREVISADO1.RECIBIDO_ABOG,
                ...
                if (Estado == "ACEP")
                {
                    var q = ctx.PSOLICITUDES.Where(t => t.VIG_SOL == Vigencia && t.ID_ABOG_ENC == UserName && t.HREVISADO1.RECIBIDO_ABOG == "S" && t.HREVISADO1.CONCEPTO_REVISADO == "A")
                        .Select(
                t => new vPSolicitudes
                {
                    EST_REC = t.HREVISADO1.RECIBIDO_ABOG,
                ...
                if (Estado == "RECHA")
                {
                    var q = ctx.PSOLICITUDES.Where(t => t.VIG_SOL == Vigencia && t.ID_ABOG_ENC ==UserName && t.HREVISADO1.RECIBIDO_ABOG == "S" && t.HREVISADO1.CONCEPTO_REVISADO == "R")
                        .Select(
                            t => new vPSolicitudes
                    {
                    EST_REC = t.HREVISADO1.RECIBIDO_ABOG,
