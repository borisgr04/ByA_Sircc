...
var masterP = (function ($) {
    ...
    var Modulos = [
       { codigo: "PLAN4", nombre: "Planeación", icono: "icon-book" },
       { codigo: "ESPR4", nombre: "Estudios Previos", icono: "icon-book" },
       { codigo: "SOLI4", nombre: "Procesos", icono: "icon-briefcase" },
       { codigo: "CONT4", nombre: "Contratos", icono: "icon-edit" },
       { codigo: "SUPV4", nombre: "Supervisión", icono: "icon-eye-open" },
       { codigo: "REPO4", nombre: "Reportes", icono: "icon-book" },
       { codigo: "ADMI4", nombre: "Administración", icono: "icon-dashboard" },       
       { codigo: "DTBS4", nombre: "Datos Básicos", icono: "icon-dashboard" }       
    ];
