<%@ Page Title="" Language="C#" MasterPageFile="~/SiteBS.Master" AutoEventWireup="true" CodeBehind="GesMisSolicitudes.aspx.cs" Inherits="wfSircc.Solicitudes.GesMisSolicitudes" %>
    ...
    <div class="row">
        ...
        <div class="col-md-7">
            <div class="btn-toolbar">
                    ...
                    <button type="button" value="Nuevo" id="BtnRecibir" class="btn btn-default">
                        <span class="glyphicon glyphicon-hand-up"></span> Recibir
                    </button>
                    <button type="button" value="Editar" id="BtnRevisar" class="btn btn-default">
