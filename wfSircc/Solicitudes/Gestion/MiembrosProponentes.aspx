<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SiteBS.Master" CodeBehind="MiembrosProponentes.aspx.cs" Inherits="wfSircc.Solicitudes.Gestion.MiembrosProponentes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group row">
                ...
                <div class="col-lg-5" id="dvdID_PROP">
                    <input type="text" class="form-control datMiembroProponente" id="txtID_PROP" disabled="disabled" />
                </div>
            </div>
            <div class="form-group row">
                <div class="col-lg-2 text-right">
    ...
    <script src="js/MiembrosProponentes.js" type="text/javascript"></script>
</asp:Content>
