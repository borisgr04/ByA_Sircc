var Contratos = (function () {
    ...
    var tema;
    var CodCon;
    var TituloForm = "Gestión Detallada de Contrato <small> por Supervisor</small>";
        ...
        $(gridCon).jqxGrid(
                    {
                        ...
                        columns: [
                            ...
                            { text: 'Observación', datafield: 'OBS_EST', width: 150, columntype: 'numberinput', cellsalign: 'right', cellsformat: 'c2' },
