var objregistro = (function () {
    ...
    var urlToAbrir = "/Servicios/DatosBasicosG/wsEtapas.asmx/Get";
    var urlToGuardarNuevo = "/Servicios/DatosBasicosG/wsEtapas.asmx/Insert";
    var urlToGuardarMod = "/Servicios/DatosBasicosG/wsEtapas.asmx/Update";
    ...
    var Editar = function () {
        ...
        $("#guardarButton").byaSetHabilitar(true);
        $("#cancelarButton").byaSetHabilitar(true);
        $("#txtCOD_ETA").byaSetHabilitar(false);
...
$(function () {
    byaSite.SetModuloP({ TituloForm: "Pólizas", Modulo: "Gestión", urlToPanelModulo: "gPolizas.aspx", Cod_Mod: "DTBS4", Rol: "DTBS4Etapas" });
    objregistro.init();
});
