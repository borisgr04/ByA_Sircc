var MiembrosProponentes = (function () {
    ...
    var urlToAbrir = "../../Servicios/wsProponentes.asmx/GetMiembroTerceros";
    var urlToGuardarNuevo = "../../Servicios/wsProponentes.asmx/InsertMiembroTerceros";
    var urlToGuardarMod = "../../Servicios/wsProponentes.asmx/UpdateMiembroTerceros";
    ...
    var _esValido = function () {
        ...
        var _MensajeFinalValidacion = function () {
            ...
            if (errorValoresEstimados) {
                $("#LbMsg").append(" El 'valor total estimado' no puede ser menor a el 'valor estimado en la vigencia actual'");
            }
        };
...
$(function () {
    byaSite.SetModuloP({ TituloForm: "Gestión", Modulo: "Miembros", urlToPanelModulo: "gMiembros.aspx", Cod_Mod: "ADMIN", Rol: "ADM_TERC" });
