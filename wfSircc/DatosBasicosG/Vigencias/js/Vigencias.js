var objregistro = (function () {
    ...
    var urlToGuardarNuevo = "/Servicios/DatosBasicosG/wsVigencias.asmx/Insert";
...
$(function () {
    byaSite.SetModuloP({ TituloForm: "Vigencias", Modulo: "Gestión", urlToPanelModulo: "gVigencias.aspx", Cod_Mod: "DTBS4", Rol: "DTBS4Vigencias" });
    objregistro.init();
});
