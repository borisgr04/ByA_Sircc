...
function handle_side_menu() {
        ...
        // console.log('=== $(".nav-list .dropdown-toggle"): ' + $(".nav-list .dropdown-toggle").size());
        // console.log('=== a: ' + a);
        $(".nav-list .dropdown-toggle").each(function() {
                ...
                $(this).on("click", function() {
                        ...
                        // console.log('=== $(".open > .submenu"): ' + $(".open > .submenu").size());
...
// by ysyun 
function setSkinGrey() {
        // force add class to skin-1 style (grey)
        var b = "skin-1";
        var a = $(document.body);
        a.attr("class", a.hasClass("navbar-fixed") ? "navbar-fixed" : "");
        if (b != "default") {
