var gPAA = (function () {
    ...
    var _addHandlers = function () {
        ...
        $('#BtnNuevo').click(function () {
            window.location.href = "PAA.aspx?idmpaa=" + idMPAA;
        });
        $('#BtnEditar').click(function () {
            var objPAA = gPAA.getRecord();
            window.location.href = "PAA.aspx?idObjPAA=" + objPAA.ID + "&op=E&idmpaa=" + idMPAA;
        });
        $('#BtnDetalles').click(function () {
            var objPAA = gPAA.getRecord();
            window.location.href = "PAA.aspx?idObjPAA=" + objPAA.ID + "&op=D&idmpaa=" + idMPAA;
        });
    ...
    var getDataAdapter = function () {
        var source = {
            ...
            datafields: [
                    ...
                    { name: 'MOD_SEL' },
                    { name: 'FUE_SEL' },
                    { name: 'VAL_TOT_EST', type: 'number' },
                    { name: 'VAL_VIG_EST', type: 'number' },
                    { name: 'VIG_FUT' },
                    { name: 'EST_SOL_VF' },
        ...
        $(gridCon).jqxGrid(
                    {
                        ...
                        { text: 'Valor Total Estimado', datafield: 'VAL_TOT_EST', width: 150, filtertype: 'textbox', cellsformat: 'F2', cellsalign: 'right' },
                        { text: 'Valor Estimado Vigencia', datafield: 'VAL_VIG_EST', width: 170, filtertype: 'textbox', cellsformat: 'F2', cellsalign: 'right' }
