var admObligC = (function () {
    ...
    function _createToolGrid() {
        ...
        addButton.byaSetHabilitar(!admObligC.disabled);
        deleteButton.byaSetHabilitar(!admObligC.disabled);
        ...
        $(grid).jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Grupo', datafield: 'GRUPO', width: 80, cellclassname: cellclass,hidden: true },
