var admCDP = (function () {
	...
	var tema = admCDP.config.theme;
        ...
        $("#txtValCDP").jqxNumberInput({ width: '150px', height: '25px', min: 0, max: 9999999999, digits: 10, symbol: '$', theme: tema });
        ...
        $("#BtnEPGuardarCDP").jqxButton({ theme: tema, width: 100, height: 25,disabled:admCDP.disabled });
