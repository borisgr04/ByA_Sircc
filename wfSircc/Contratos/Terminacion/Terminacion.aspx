<%@ Page Title="" Language="C#" MasterPageFile="~/SiteBS.Master" AutoEventWireup="true" CodeBehind="Terminacion.aspx.cs" Inherits="wfSircc.Contratos.Terminacion.Terminacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-default">
                    <div class="panel-heading">Terminacion<span style="margin-left:20px" class="label label-default" id="cdpTip"></span></div>
    ...
    <div class="form-horizontal" role="form" id="formDATOS">
           <div class="row">                
                ...
                <div class="form-group">
                         ...
                         <div class="col-md-2">
                             <button type="button" class="btn btn-success" id="BtnguardarTerminacion">
                             <span class="glyphicon glyphicon-floppy-saved">
                             </span>Guardar</button>         
                         </div>    
                     
                        <div class="col-md-2">
                             <button type="button" class="btn btn-danger" id="BtncancelarTerminacion">
                             <span class="glyphicon glyphicon-floppy-saved">
        ...
        <script src="js/Terminacion.js"></script>
</asp:Content>
